...
let tests =
  testList
    ...
    [ testCaseAsync "should return an empty list if given no projects"
      ...
      testCaseAsync "should discover tests given a single xunit project"
      <| async {
        ...
        let sources =
          [ Path.Combine(
              ...
              "VSTest.XUnit.Tests/bin/Debug/net8.0/VSTest.XUnit.Tests.dll"
            ) ]
