namespace FsAutoComplete.Adaptive
    ...
    module AdaptiveExtensions =
        type FSharp.Data.Adaptive.ChangeableHashMap<'Key,'Value> with
            ...
            /// </summary>
            member
              AddOrUpdate: key: 'Key * adder: ('Key -> 'Value) *
                           updater: ('Key -> 'Value -> 'Value) -> bool
        type FSharp.Data.Adaptive.ChangeableHashMap<'Key,'Value> with
            ...
            /// </summary>
            member
              AddOrElse: key: 'Key * adder: ('Key -> 'Value) *
                         updater: ('Key -> 'Value -> unit) -> unit
    ...
    /// </summary>
    type MapDisposableTupleVal<'T1,'T2,'Disposable
                                 when 'Disposable :> System.IDisposable> =
        inherit FSharp.Data.Adaptive.AVal.AbstractVal<'T2>

        new: mapping: ('T1 -> 'T2 * 'Disposable) *
             input: FSharp.Data.Adaptive.aval<'T1> ->
    ...
    module AVal =
        ...
        val mapOption:
          f: ('a -> 'b) ->
            (FSharp.Data.Adaptive.aval<'a option> ->
               FSharp.Data.Adaptive.aval<'b option>)

        /// <summary>
        /// Maps and calls dispose before mapping of new values. Useful for cleaning up callbacks like AddMarkingCallback for tracing purposes.
        /// </summary>
        val mapDisposableTuple:
          mapper: ('a -> 'b * #System.IDisposable) ->
            value: FSharp.Data.Adaptive.aval<'a> ->
            FSharp.Data.Adaptive.aval<'b>
        ...
        module Observable =
            ...
            val onOutOfDateWeak:
              aval: 'a -> System.IObservable<'a>
                when 'a :> FSharp.Data.Adaptive.aval<'b>

            /// <summary>Creates an observable on the aval that will be executed whenever the avals value changed.</summary>
            /// <param name="aval">The aval to get out-of-date information from.</param>
            val onValueChangedWeak:
              aval: #FSharp.Data.Adaptive.aval<'b> -> System.IObservable<'b>
    ...
    module AMap =
        ...
        type internal MultiSetMap<'k,'v> =
            FSharp.Data.Adaptive.HashMap<'k,FSharp.Data.Adaptive.HashSet<'v>>
        ...
        module internal MultiSetMap =
            ...
            val add:
              key: 'k ->
                value: 'v -> m: MultiSetMap<'k,'v> -> MultiSetMap<'k,'v>

            val remove:
              key: 'k ->
                value: 'v -> m: MultiSetMap<'k,'v> -> bool * MultiSetMap<'k,'v>

            val find:
              key: 'k ->
                m: MultiSetMap<'k,'v> -> FSharp.Data.Adaptive.HashSet<'v>

        /// Reader for batchRecalc operations.
        [<Sealed>]
        type BatchRecalculateDirty<'k,'a,'b> =
            inherit FSharp.Data.Traceable.AbstractReader<FSharp.Data.Adaptive.HashMapDelta<'k,
                                                                                           'b>>

            new: input: FSharp.Data.Adaptive.amap<'k,'a> *
                 mapping: (FSharp.Data.Adaptive.HashMap<'k,'a> ->
                             FSharp.Data.Adaptive.HashMap<'k,
                                                          FSharp.Data.Adaptive.aval<'b>>) ->
                   BatchRecalculateDirty<'k,'a,'b>

            override
              Compute: t: FSharp.Data.Adaptive.AdaptiveToken ->
                         FSharp.Data.Adaptive.HashMapDelta<'k,'b>

            override
              InputChangedObject: t: obj *
                                  o: FSharp.Data.Adaptive.IAdaptiveObject ->
                                    unit
        ...
        val tryFindAndFlatten:
          key: 'Key ->
            map: FSharp.Data.Adaptive.amap<'Key,
        ...
        val tryFindA:
          key: 'Key ->
            map: FSharp.Data.Adaptive.amap<'Key,
                                           #FSharp.Data.Adaptive.aval<'Value>> ->
            FSharp.Data.Adaptive.aval<'Value option>
        ...
        val batchRecalcDirty:
          mapping: (FSharp.Data.Adaptive.HashMap<'K,'T1> ->
                      FSharp.Data.Adaptive.HashMap<'K,
                                                   FSharp.Data.Adaptive.aval<'T2>>) ->
            map: FSharp.Data.Adaptive.amap<'K,'T1> ->
            FSharp.Data.Adaptive.amap<'K,'T2>

        val mapWithAdditionalDependenies:
          mapping: (FSharp.Data.Adaptive.HashMap<'K,'T1> ->
                      FSharp.Data.Adaptive.HashMap<'K,('T2 * #seq<'b>)>) ->
            map: FSharp.Data.Adaptive.amap<'K,'T1> ->
            FSharp.Data.Adaptive.amap<'K,'T2>
    ...
    type internal RefCountingTaskCreator<'a> =
        ...
        new: create: (System.Threading.CancellationToken ->
                        System.Threading.Tasks.Task<'a>) ->
               RefCountingTaskCreator<'a>
    ...
    and [<Class>] AdaptiveCancellableTask<'a> =
        ...
        new: cancel: (unit -> unit) * real: System.Threading.Tasks.Task<'a> ->
               AdaptiveCancellableTask<'a>
    ...
    type asyncaval<'a> =
        ...
        abstract
          GetValue: FSharp.Data.Adaptive.AdaptiveToken ->
                      AdaptiveCancellableTask<'a>
    ...
    module CancellableTask =
        ...
        val inline ofAdaptiveCancellableTask:
          ct: AdaptiveCancellableTask<'a> ->
            ctok: System.Threading.CancellationToken ->
            System.Threading.Tasks.Task<'a>
    ...
    module Async =
        ...
        val inline ofAdaptiveCancellableTask:
          ct: AdaptiveCancellableTask<'a> -> Async<'a>
    ...
    module Extensions =
        type IcedTasks.CancellableTasks.CancellableTaskBuilderBase with
            ...
            member
              inline Source: ct: AdaptiveCancellableTask<'a> ->
                               (System.Threading.CancellationToken ->
                                  System.Runtime.CompilerServices.TaskAwaiter<'a>)
    ...
    module AsyncAVal =
        ...
        /// </remarks>
        val forceCancellableTask:
          value: asyncaval<'a> -> IcedTasks.CancellableTasks.CancellableTask<'a>
        ...
        type AbstractVal<'a> =
            ...
            abstract
              Compute: FSharp.Data.Adaptive.AdaptiveToken ->
                         AdaptiveCancellableTask<'a>

            member
              GetValue: token: FSharp.Data.Adaptive.AdaptiveToken ->
                          AdaptiveCancellableTask<'a>
        ...
        val ofCancellableTask:
          value: IcedTasks.CancellableTasks.CancellableTask<'a> -> asyncaval<'a>
        ...
        /// </summary>
        val mapAsync:
          mapping: ('a -> Async<'b>) -> input: asyncaval<'a> -> asyncaval<'b>
        ...
        /// </summary>
        val mapSync:
          mapping: ('a -> System.Threading.CancellationToken -> 'b) ->
            input: asyncaval<'a> -> asyncaval<'b>
        ...
        val map2:
          mapping: ('a ->
            ...
            ca: asyncaval<'a> -> cb: asyncaval<'b> -> asyncaval<'c>
        ...
        val bind:
          mapping: ('a -> System.Threading.CancellationToken -> asyncaval<'b>) ->
            value: asyncaval<'a> -> asyncaval<'b>

        /// Returns a new async adaptive value that adaptively applies the mapping function to the given
        /// optional adaptive inputs.
        val mapOption:
          f: ('a -> System.Threading.CancellationToken -> 'b) ->
            value: asyncaval<'a option> -> asyncaval<'b option>
    ...
    type AsyncAValBuilder =
        ...
        member
          inline Bind: value: asyncaval<'T1> * mapping: ('T1 -> asyncaval<'T2>) ->
                         asyncaval<'T2>

        member
          inline Bind: value: asyncaval<'T1> *
                       mapping: ('T1 ->
                                   System.Threading.CancellationToken ->
                                   asyncaval<'T2>) -> asyncaval<'T2>

        member
          inline BindReturn: value: asyncaval<'T1> *
                             mapping: ('T1 -> System.Threading.Tasks.Task<'T2>) ->
                               asyncaval<'T2>

        member
          inline BindReturn: value: asyncaval<'T1> *
                             mapping: ('T1 -> Async<'T2>) -> asyncaval<'T2>
        ...
        member
          inline MergeSources: v1: asyncaval<'T1> * v2: asyncaval<'T2> ->
                                 asyncaval<'T1 * 'T2>
    ...
    module AsyncAValBuilderExtensions =
        ...
        type AsyncAValBuilder with
            ...
            member
              inline Source: value: FSharp.Data.Adaptive.aval<'T> ->
                               asyncaval<'T>
        type AsyncAValBuilder with

            member
              inline Source: value: System.Threading.Tasks.Task<'T> ->
                               asyncaval<'T>
        type AsyncAValBuilder with
        ...
        type AsyncAValBuilder with
            ...
            member
              inline BindReturn: value: asyncaval<'T1> * mapping: ('T1 -> 'T2) ->
                                   asyncaval<'T2>
    ...
    module AMapAsync =
        ...
        val mapAVal:
          mapper: ('Key ->
                     'InValue ->
                     System.Threading.CancellationToken -> asyncaval<'OutValue>) ->
            map: #FSharp.Data.Adaptive.amap<'Key,'b> ->
        ...
        val tryFindA:
          key: 'Key ->
            map: FSharp.Data.Adaptive.amap<'Key,#asyncaval<'Value>> ->
            asyncaval<'Value option>

        /// Adaptively looks up the given key in the map and flattens the value to be easily worked with. Note that this operation should not be used extensively since its resulting aval will be re-evaluated upon every change of the map.
        val tryFindAndFlatten:
          key: 'Key ->
            map: FSharp.Data.Adaptive.amap<'Key,asyncaval<'Value option>> ->
            asyncaval<'Value option>
