...
type ParseAndCheckResults =
    ...
    member TryFindIdentifierDeclaration:
        pos: Position -> lineStr: LineStr -> Async<Result<FindDeclarationResult, string>>
    ...
    member TryGetToolTipEnhanced:
        pos: Position -> lineStr: LineStr -> Result<TryGetToolTipEnhancedResult option, string>
