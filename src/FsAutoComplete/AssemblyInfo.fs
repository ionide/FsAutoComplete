...
[<assembly: AssemblyMetadataAttribute("githash","2c05742e7b27a1be78f9791375a2adc096d4c461")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyMetadata_githash = "2c05742e7b27a1be78f9791375a2adc096d4c461"
