...
type AdaptiveState =
  ...
  member GetOpenFileSource: filePath: string<LocalPath> -> Async<IFSACSourceText option>
  member GetOpenFileOrRead: filePath: string<LocalPath> -> Async<VolatileFile option>
