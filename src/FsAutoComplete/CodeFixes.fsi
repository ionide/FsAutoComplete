...
module Navigation =
    ...
    val walkBackUntilConditionWithTerminal:
        lines: NamedText -> pos: LspTypes.Position -> condition: (char -> bool) -> terminal: (char -> bool) -> LspTypes.Position option

    val walkForwardUntilConditionWithTerminal:
        lines: NamedText -> pos:LspTypes.Position -> condition: (char -> bool) -> terminal: (char -> bool) -> LspTypes.Position option

    val walkBackUntilCondition: lines: NamedText -> pos: LspTypes.Position -> condition: (char -> bool) -> LspTypes.Position option
    val walkForwardUntilCondition: lines: NamedText -> pos: LspTypes.Position -> condition: (char -> bool) -> LspTypes.Position option
